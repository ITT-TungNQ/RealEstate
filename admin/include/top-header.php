...
<!--        <li  class="dropdown" id="profile-messages" >
            ...
            <ul class="dropdown-menu">
                <li><a href="http://192.168.1.220:8080/RealEstate/admin/user-profile"><i class="icon-user"></i> Thông tin tài khoản</a></li>
                <li class="divider"></li>
...
<!--        <li class="dropdown" id="menu-messages">
        ...
        <li class=""><a title="" href="http://192.168.1.220:8080/RealEstate/admin/user-profile"><i class="icon-user"></i> <?php echo $_SESSION['login_user']['LastName'] . ' ' . $_SESSION['login_user']['MiddleName'] . ' ' . $_SESSION['login_user']['FirstName'] ?></a></li>
