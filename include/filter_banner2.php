        ...
        <div class="right_bar">
            <div class="single_leftbar wow fadeInDown">
                ...
                <div class="singleleft_inner">
                    <form id="search_form" name="search_form" method="post" action="http://192.168.1.220:8080/RealEstate/the-loai/tim-kiem">
            ...
            <div class="single_leftbar wow fadeInDown">
                ...
                <div class="singleleft_inner">
                    <ul class="label_nav">
                        <li><a href="http://192.168.1.220:8080/RealEstate/the-loai/dat-nen">Thị trường đất nền</a></li>

                        <li><a href="http://192.168.1.220:8080/RealEstate/the-loai/du-an-moi">Công trình, dự án mới</a></li>
