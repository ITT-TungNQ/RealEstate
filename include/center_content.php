<div class="col-lg-7 col-md-7 col-sm-8 col-xs-12">
    <div class="row">
        <div class="middle_bar">
                            ...
                            if ($item == 0) {
                                ...
                                <div class="item active"> 
                                    ...
                                    <div class="carousel-caption">
                                        <h1><a href="http://192.168.1.220:8080/RealEstate/chi-tiet/<?php echo (makeURL($tin['Title'])); ?>-<?php echo($tin['NewsID']); ?>"><?php echo ($tin['Title']); ?></a></h1>
                                    </div>
                                </div>
                                <?php
                                $item++;
            ...
            <div class="single_category  wow fadeInDown">
                <div class="category_title"> <a href="http://192.168.1.220:8080/RealEstate/the-loai/du-an-moi">DỰ ÁN MỚI</a></div>
                <div class="single_category_inner">
            ...
            <div class="category_three_fourarea wow fadeInDown">
                <div class="category_three">
                    <div class="single_category">
                        <div class="category_title">
                            <a href="http://192.168.1.220:8080/RealEstate/the-loai/can-ho">NHÀ BÁN</a>
                        </div>
                        <div class="single_category_inner">
                                ...
                                foreach ($nhaban as $a) {
                                    ...
                                    <li>
                                        <div class="catgimg_container"> 
                                            <a class="catg1_img" href="http://192.168.1.220:8080/RealEstate/chi-tiet/<?php echo(makeURL($a['Title'])); ?>-<?php echo($a['NewsID']); ?>"> 
                                                <img src="<?php echo($a['IllustrationURL']); ?>" alt=""> 
                                            </a>
                                        </div>
                                        <a class="catg_title" href="http://192.168.1.220:8080/RealEstate/chi-tiet/<?php echo(makeURL($a['Title'])); ?>-<?php echo($a['NewsID']); ?>">
                                            <?php echo ($a['Title']); ?>
                                        </a>
                                        <div class="sing_commentbox">
                                            <p><i class="fa fa-calendar"></i><?php echo date('d/m/Y', strtotime($a['LastUpdated'])); ?></p>
                            ...
                            <div class="catg3_bottompost wow fadeInDown">
                                <ul class="catg3_snav">
                                    ...
                                    <?php foreach ($nhaban2 as $a) {
                                        ...
                                        <li>
                                            <div class="media">
                                                <a class="media-left" href="http://192.168.1.220:8080/RealEstate/chi-tiet/<?php echo(makeURL($a['Title'])); ?>-<?php echo($a['NewsID']); ?>">
                                                    <img src="<?php echo($a['IllustrationURL']); ?>" alt=""></a>
                ...
                <div class="category_four wow fadeInDown">
                    <div class="single_category">
                        <div class="category_title"><a href="http://192.168.1.220:8080/RealEstate/the-loai/biet-thu">BIỆT THỰ</a></div>
                        <div class="single_category_inner">
                            <ul class="catg_nav catg_nav3">
                                <?php
            ...
            <div class="single_category wow fadeInDown">
                <div class="category_title"> <a href="http://192.168.1.220:8080/RealEstate/the-loai/dat-nen">ĐẤT NỀN</a></div>
                <div class="single_category_inner">
                    <ul class="catg3_snav catg5_nav">
                        ...
                        <li>
                            <div class="media"> 
                                <a href="http://192.168.1.220:8080/RealEstate/chi-tiet/<?php echo(makeURL($a['Title'])); ?>-<?php echo($a['NewsID']); ?>" class="media-left">
